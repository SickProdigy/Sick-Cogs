...
The cog also provides many category commands such as `[p]hentai`, `[p]porngif`, `[p]gonewild`, and other NSFW-only media commands. Use `[p]help Nsfw` in an age-restricted channel for the full media-command list; normal channels show only commands available there.
